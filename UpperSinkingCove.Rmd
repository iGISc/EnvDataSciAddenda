# Exploring terrain mapping and water samples in a karst area
...
tm_shape(hillsh,bbox=newbounds) +
  ...
  tm_shape(ents) + tm_dots(col="red", shape=16, size=0.33, alpha=0.5) + 
  #tm_shape(wChem) + tm_symbols(size="TH", col="Lithology", scale=2, shape="siteType", alpha=0.5) +
...
## Interactive maps with tmap view mode
...
Interactive map with multiple choices of basemaps (changed the order to set the default), showing lithology:

```{r Lithology, fig.cap="Interactive map with lithology"}
