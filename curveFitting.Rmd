...
One popular way of handling Fitting to various polynomial orders (powers) is easy with the `poly` function. We'll try orders 1 through 3 PAR_ave~poly(GPP_sum), summarizing the results of a model ... 

### poly 1

This is the same a normal linear model.
