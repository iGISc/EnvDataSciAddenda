...
>Note: Much of this notebook is based on an exercise in SFSU's Geog 313 class developed by Andrew Oliphant, using Excel. Most of the text is from that exercise, but the methods are coded in R.
